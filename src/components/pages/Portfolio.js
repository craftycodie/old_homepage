			...
			<div className="centerMargins" id="portfolio">
				<div className="projectSection">
					...
					<div className="row">
						...
						<Project name="Armour Customizer" description="A simple WPF application to help Halo: Online players edit their settings." blogPost="5b17434ccc4d2a00144b68db" primaryTags={["WPF", "C#"]}/>
						...
						<Project name="Halo: Online Headhunter" description="A research project, adding a gamemode to Halo: Online" img="./img/portfolio/headhunter.png" blogPost="5b171bc9e2243c001487ca7c" primaryTags={["C++", "x86 Assembly"]}/>
