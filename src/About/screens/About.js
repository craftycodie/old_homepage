...
import { loadWidgets as loadTwitterWidgets } from '../utils/twitterWidget'
      ...
      <div className='page'>
        ...
        <div id='about' className='centerMargins'>
          ...
          <div className='row'>
            ...
            <div className='col-md-6'>
              <h2>Spotify</h2>
              <iframe src="https://open.spotify.com/embed/user/a13x231/playlist/0dSeGKiqDBhSYDtgoM16oH" width="300" height="380" frameborder="0" allowtransparency="true" allow="encrypted-media"></iframe>
            </div>
          </div>
        </div>
      </div>
